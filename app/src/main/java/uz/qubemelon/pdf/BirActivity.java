    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.lesson_two:
                String  lesson_two="bir/ikki.pdf";
            ...
            case R.id.lesson_third:
                ...
                String  lesson_third_name="bir/uch.pdf";
            ...
            case R.id.lesson_four:
                ...
                String  lesson_four_name="bir/turt.pdf";
            ...
            case R.id.lesson_five:
                ...
                String  lesson_five_name="bir/besh.pdf";
            ...
            case R.id.lesson_six:
                ...
                String lesson_six_name = "bir/olti.pdf";
            ...
            case R.id.lesson_seven:
                String lesson_seven = "bir/yetti.pdf";
            ...
            case R.id.lesson_eigthn:
                ...
                String  lesson_eigth_name="bir/sakkiz.pdf";
            ...
            case R.id.lesson_nine:
                ...
                String lesson_nine_name = "bir/tuq.pdf";
                Intent lesson_nine_intent = new Intent(getApplicationContext(),FileDisplayActivity.class);
                lesson_nine_intent.putExtra("file", lesson_nine_name);
                startActivity(lesson_nine_intent);
                break;


            case R.id.lesson_ten:
                String lesson_ten = "bir/un.pdf";
